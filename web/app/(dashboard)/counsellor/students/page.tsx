        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                 ...
                 <Dialog open={isDialogOpen} onOpenChange={setDialogOpen}>
                    ...
                    <DialogContent>
                        <DialogHeader><DialogTitle>Connect with a new Student</DialogTitle></DialogHeader>
                        <form onSubmit={handleSubmit(onAddStudent)} className="space-y-4 py-4">
                            <div>
                                <Label htmlFor="studentId">Student ID</Label>
                                <Input id="studentId" {...register("studentId", { required: true })} placeholder="Enter the student's unique ID"/>
                            </div>
