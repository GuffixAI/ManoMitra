...
"use client";
import { useMyStudents, useAddStudent, useRemoveStudent } from "@/hooks/api/useCounsellors";
      ...
      <div className="flex justify-between items-center">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit(onAddStudent)} className="space-y-4 py-4">
              <div>
        ...
        <CardContent className="pt-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {students?.map((student: any) => (
              <div key={student._id} className="relative flex items-center space-x-4 p-4 border rounded-lg group">
                <Avatar>
                ...
                <Button 
                    ...
                    disabled={removeStudentMutation.isPending && removeStudentMutation.variables === student._id}
                >
